...
// Slide-in calendar with date filtering
        ...
        this.container.innerHTML = `
            <div class="calendar-panel ${this.isVisible ? 'visible' : ''}">
                <div class="calendar-header">
                    <button class="calendar-prev-btn" aria-label="Previous month">◀</button>
                    <h3 class="calendar-month-title"></h3>
                    <button class="calendar-next-btn" aria-label="Next month">▶</button>
                </div>
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            html += `
                <div class="calendar-day ${hasEpisodes ? 'has-episode' : ''} ${isToday ? 'today' : ''}"
                    ...
                    ${hasEpisodes ? '<span class="dot-indicator"></span>' : ''}
                </div>
            `;
        }
